...
class UserAgree extends StatefulWidget {

  @override
  State<UserAgree> createState() => _UserAgreeState();
}

class _UserAgreeState extends State<UserAgree> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            HeaderWidget(text: 'Пользовательское соглашение'),
